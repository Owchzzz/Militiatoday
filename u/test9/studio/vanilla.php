...
window.location="vanilla.php?channelid=<?php echo $channelid; ?>&reset=true";
...
<body>
<div class="wrap"><img src="logo.png" style="position: relative; top: 0; left: 0;"/>
<div class="vanilla-container" style="position: absolute; top: 0; left: 0;"/>
<? $webtv->playNow();?>
</div>
</div>
...
<iframe name="control" id="control" src="loadif.html" frameborder="0" height="1px" width="1px"></iframe>
<iframe id="control" width="1px" height="1px" frameborder="0" src="loadif.html" name="control"></iframe>
