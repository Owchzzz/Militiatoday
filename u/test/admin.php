...
@require 'youtvfunctions.php';
	...
	// to be really safe.
	if ($_POST['user']=="admin" && $_POST['password']== "Temp0115!"){
		$access = true;
	} else { $access = false;}
	?>
...
<![endif]-->
	<div class="heading clear">
		<p class="heading_title">CableV2 Admin</p>
...
<iframe src="http://cablev2.com/tv/play.php?channelid=edim" width="250px" height="180px" border="0" frameborder="no" muted="muted"></iframe>
</div>
