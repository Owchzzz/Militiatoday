...
Accounts 
					...
					<ul>
						...
						<li><a href="index.php">Manage Accounts</a></li> <!-- Add class "current" to sub menu items also -->
						<li><a class="current" href="directory.php">View Directory</a></li>
			...
			<li> 
					<a href="#tab3" class="nav-top-item"> <!-- Add the class "current" to current menu item -->
Admin Settings 
					</a>
					<ul>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						...
						<table>
							...
							<tbody>
								<tr>
									<td><img src="channelicon.png" height="34px" width="34px" /></td>
									<td><a href="#" title="title">Account Name</a></td>
									<td>This is a short description of the user account</td>
									
								</tr>
									<tr>
									<td><img src="channelicon.png" height="34px" width="34px" /></td>
									<td><a href="#" title="title">Account Name</a></td>
									<td>This is a short description of the account</td>
