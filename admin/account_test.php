	...
	<body id="login">
		...
		<div id="login-wrapper" class="png_bg">
			...
			<div id="login-content">
				...
				<form action="account_test.php" method="post">
...
echo "<META http-equiv=\"refresh\" content=\"0;URL=http://militiatoday.com/u/$uid/admin.php\">";
    ...
    // Unknown request
    $access = "<b><font color=\"#cc0000\">Hey! That Channel ID Does Not Exist in our database! Please check your inputs. If you are still having trouble, you might want to try registering a new account.</font></b>";
}
echo "$access";
}
?>
