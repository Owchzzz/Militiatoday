...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<title>Channel Administration Console | Sign In</title>
	...
	<body id="login">
		...
		<div id="login-wrapper" class="png_bg">
			<div id="login-top">
				...
				<h1>Channel Administration Console</h1>
				<!-- Logo (221px width) -->
				<img id="logo" src="resources/images/logo.png" alt="Channel Administration Console logo" />
			</div> <!-- End #logn-top -->
...
if (!isset($_REQUEST['login'])) {
   echo "Channel Site Admin Console";
}
else {
