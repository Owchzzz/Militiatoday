<?php
/**
 * The Header for our groups.
 */

global $THEMEREX_sidemenu, $THEMEREX_groupmenu, $THEMEREX_usermenu_show, $logo_text, $logo_slogan, $logo_icon, $logo_image, $logo_side, $logo_fixed;
					...
					<div class="mainmenu_area">
						<div class="main">
							<div class="logo logo_<?php echo get_custom_option('logo_align'); ?><?php echo $logo_text ? ' with_text' : ''; ?>">
								<a href="<?php echo home_url(); ?>"><?php echo $logo_image ? '<img src="'.$logo_image.'" class="logo_main" alt=""><img src="'.$logo_fixed.'" class="logo_fixed" alt="">' : ''; ?><?php echo $logo_text ? '<span class="logo_text">'.apply_filters('theme_logo_text', $logo_text, 'groupmenu').'</span>' : ''; ?><?php echo $logo_slogan ? '<span class="logo_slogan">'.$logo_slogan.'</span>' : ''; ?></a>
							</div>
